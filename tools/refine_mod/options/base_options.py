...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./logs/refine', help='models are saved here')
        # self.parser.add_argument('--checkpoints_dir', type=str, default='../../exp_pix2pixHD_release/checkpoints', help='models are saved here')
        ...
        self.parser.add_argument('--nerf_folder', type=str, default='nerf_folder')
        self.parser.add_argument('--gt_folder', type=str, default='gt_folder')
        self.parser.add_argument('--result_folder', type=str, default='result_folder')
        ...
        self.parser.add_argument('--no_flip', action='store_false',
                                 help='if specified, flip the images for data argumentation')
