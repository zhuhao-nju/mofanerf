...
def evaluate(img, imgname, respth='/home/zhang/zydDataset/asianFaces/foreground/', cp='Seg_79999_iter.pth', delete_list=[0], save_im=False):
    ...
    with torch.no_grad():
        ...
        vis_im, mask = vis_parsing_maps(h, w, image, parsing, stride=1, save_path=osp.join(respth, imgname), save_im=save_im, delete_list=delete_list)
    return vis_im, mask
