...
def create_nerf(args):
    ...
    #                                                             embeddirs_fn=embeddirs_fn,
    #                                                             netchunk=args.netchunk)
    render = render_class.myRenderer(embed_fn=embed_fn, embeddirs_fn=embeddirs_fn, netchunk=args.netchunk, uvCodesLen=args.input_ch_textureCodes, expCodesLen=args.input_ch_expCodes)
