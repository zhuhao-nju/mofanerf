...
def load_ori_mesh(fn):
    return trimesh.load(fn,resolver=None,split_object=False,group_material=False,skip_materials=False,maintain_order=False,process=False)
...
expressionName=["neutral","smile","mouth_stretch","anger","jaw_left","jaw_right","jaw_forward","mouth_left","mouth_right","dimpler",
                "chin_raiser","lip_puckerer","lip_funneler","sadness","lip_roll","grin","cheek_blowing","eye_closed","brow_raiser","brow_lower"]
...
for id_idx in range(1, 2):
    for exp_idx in range(1, 21):
        ...
        print("aligned mview_model saved to ../data/models_out/{}/{}_{}.obj".format(id_idx, exp_idx, expressionName[exp_idx-1]))