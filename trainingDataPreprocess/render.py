...
def generate_Rt_fix_view():
    ...
    for theta in range(-30, 60, 15):
        scaleMesh = 50
        Rt = [pose_spherical(angle, theta, 800.0 / scaleMesh) for angle in np.linspace(-90, 90, 20 + 1)[:-1]]  # par1, along axis y, left and right; par2 along axis x, up and down(90 -> -60)
